...
//        e1.run();
        ...
        // a new thread ,  called " thread- 0 " , is created and the logic on the run() is ran on this thread
        ...
        .join( method
            ...
            one those threads are terminated , the thread we invoked .join() on will " join " and
        ...
        c1.run();
// c1 is runnable so dont have start() , so we put it in thread t to use start
    ...
    //    e3.start();
        ...
        // lambda expression representing an inlune implementation of runnable
