...
--Create employees table and define its columns and their constraints
...
/*
    sINCE WE DID NOT ADDE A PRIMARY KEY TO THE procuts TABLE, 
...
ROLLBACK; --DDL statements are impliocitly committed; cannot rollback beyond them
