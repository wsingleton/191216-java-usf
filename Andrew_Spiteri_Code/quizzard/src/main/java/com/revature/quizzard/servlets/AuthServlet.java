...
import com.revature.quizzard.dto.Credentials;
...
public class AuthServlet extends HttpServlet {
    public final UserService service = new UserService(new UserRepository());
    ...
    protected  void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException{
        ...
        try{
            ...
            authUser = service.authenticate(creds.getUsername(), creds.getPassword());
