...
public class CompareDriver {
    public static void main(String[] args) {
         ...
         * 		than second one.
         */
        Car myCar = new Car(123456, "Nissan", "Rogue", "gray");
        Car yourCar = new Car(98765, "Nissan", "Murano", "maroon");
        ArrayList<Car> cars = new ArrayList<>();
        cars.add(myCar);
        cars.add(yourCar);
        cars.add(new Car(238989,"Honda", "Accord", "silver"));
        cars.add(new Car(238989,"Chevy", "Sonic", "black"));
