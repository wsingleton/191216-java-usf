...
public class UserRepository implements CrudRepository<User> {
    ...
    public void save(User newObj) {
        ...
        // save the user into the oracle database

        // create connection
        try(Connection con = ConnectionFactory.getInstance().getConnection()){

            String querry = "INSERT INTO revabook.users " +
                    "VALUES(0, ?, ?, ?, ?, ?)";
            PreparedStatement pstmt = con.prepareStatement(querry, new String[] {"user_id"});
            ...
            if(rowsInserted != 0){
                ...
                System.out.println("Successfully added new row" + rowsInserted);
