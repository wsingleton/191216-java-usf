...
public class Book {
    ...
    public Book(Integer id, String isbn, String title, Author author, Set<Genre> genres) {
        this.id = id;
        this.isbn = isbn;
        this.title = title;
        this.author = author;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getId(), getIsbn(), getTitle(), getAuthor(), getGenres(), getStockCount());
    }
