...
CREATE SEQUENCE NEW_ERS_USERS_SEQUENCE
INCREMENT BY 1
START WITH 101 ORDER;


CREATE OR REPLACE
TRIGGER NEW_ERS_USER_TRIGGER
BEFORE INSERT ON ERS_USERS
FOR EACH ROW
BEGIN
  :NEW.ERS_USERS_ID := NEW_ERS_USERS_SEQUENCE.NEXTVAL
;
END;
...
CREATE SEQUENCE NEW_ERS_REIMBURSEMENT_SEQUENCE
INCREMENT BY 1
START WITH 101 ORDER;


CREATE OR REPLACE
TRIGGER NEW_ERS_REIMBURSEMENT_TRIGGER
BEFORE INSERT ON ERS_REIMBURSEMENT
FOR EACH ROW
BEGIN
  :NEW.REIMB_ID := NEW_ERS_REIMBURSEMENT_SEQUENCE.NEXTVAL
;
END;
