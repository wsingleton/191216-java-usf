...
-- Create the department table and define its columns and their constraints 
CREATE TABLE departments( 

        dept_id         NUMBER(5) CONSTRAINT pk_departemts PRIMARY KEY,
...
CREATE TABLE employees (
        ...
        emp_ln          VARCHAR2(25),
        birthday        DATE,
        monthly_income  NUMBER(7,5),
        department_id   NUMBER(5),
        hire_date       DATE,
        job_title       VARCHAR2(125),
