...
-- Create the departments table and define its columns and their contraints
...
-- Create the employees table and define its columns and constraints
...
--Create the products table and define its columsn and some constraints
...
/* DDL statements are implicitly committed
TRUNCATE TABLE employees;
--rollback return empty table since truncate erases all the records
ROLLBACK;
*/

/* delete does not implicity committed
DELETE FROM employee;
ROLLBACK; -- we can rollback beyond them to the previous SAVEPOINT or COMMIT
*/
