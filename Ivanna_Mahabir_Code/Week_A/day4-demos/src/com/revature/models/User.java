...
public class User {
    ...
    public User(String fn, String ln, String username, String pw, Role role){
        //super(); // a call to the super class's constructor is implicitly here if it id not provided
        // if we write it, it needs to be the first line that is called
        firstName = fn; // this is not required if no parameters match the field name
        this.lastName = ln; //you can still include oit though
    ...
    public User(int id, String fn, String ln, String un, String pw, Role role){
        this(fn, ln, un, pw, role); // this call points to the previous constructor (line 17); constructor chaining/overloading
        this.id = id;
    }
