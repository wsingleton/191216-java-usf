...
@Repository
public class UserRepositories implements CrudRepositories<AppUser>{
    ...
    @Autowired
    public UserRepositories(SessionFactory factory){
        super();
    ...
    public List<AppUser> findAll() {
       ...
       Session session = sessionFactory.getCurrentSession();
           session.createQuery("from AppUser", AppUser.class).getResultList();
