...
public class Reimbursement {
    ...
    public Reimbursement(Integer id, Double amount, String submitted, String description, int authorId, Status status, Type type) {
        this.id = id;
        this.amount = amount;
        this.submitted = submitted;
        this.description = description;
    ...
    public String getSubmitted(String submitted) {
        return submitted;
    }
