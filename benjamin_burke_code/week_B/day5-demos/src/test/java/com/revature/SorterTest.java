...
public class SorterTest {
    ...
    private Sorter sut;
    /*
        JUnit rules is a component that intercepts test method calls and allows us
    ...
    @Rule
    public Timeout glabalTimeout = Timeout.seconds(5);
    ...
    public void testSolutionWithNullArray(){
        String message = "If a null object is provided, simply return to an empty in array ";
