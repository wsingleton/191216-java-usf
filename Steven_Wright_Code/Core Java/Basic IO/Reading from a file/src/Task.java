...
public class Task {
    ...
    public String[] getLines(File quoteFile) {
        ...
        // Check if the provided file is vlaid, if not return an empty array
        ...
        // use an BufferedReader to traverse each line of the file
        try {
            ...
            //Loop until there are no lines of the file
            while (line != null) {
