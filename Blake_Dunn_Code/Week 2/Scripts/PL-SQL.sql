-- This allows the DMBS to print messages to the console (OFF by default)
SET SERVEROUTPUT ON;
...
-- This is how you can invoke the function you just created to see if it works
DECLARE
...
INSERT INTO artist
VALUES (artist_pk_seq.NEXTVAL, 'Skrillex');
