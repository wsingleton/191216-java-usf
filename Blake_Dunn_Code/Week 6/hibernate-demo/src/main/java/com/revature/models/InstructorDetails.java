...
public class InstructorDetails {
    ...
    @Id
    @Column
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "details_gen")
    private int id;
    ...
    // @JsonIgnore  use this to avoid circular references
    // not explicitly calling this a column but use map by using the details field mapped by the instructor object
