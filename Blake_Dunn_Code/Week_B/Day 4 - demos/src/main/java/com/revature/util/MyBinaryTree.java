...
public class MyBinaryTree {
    ...
    private TreeNode addRecursively(TreeNode currentNode, Integer value) {
        ...
        /*
            If the value being added is neither less or greater than the value of the current ndoe
    ...
    public boolean containsValueRecursively(TreeNode currentNode, Integer value) {
        ...
        /*
            if the value contained within the current node is equal to the sought
            value, return true.
         */
        ...
        /*
            ...
            that we need to explore the nodes to the left o the current node.
