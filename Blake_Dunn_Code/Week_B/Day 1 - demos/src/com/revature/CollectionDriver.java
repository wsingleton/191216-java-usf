    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            Set
                ...
                A et is a Collection that cannot contain duplicate elements. It models
                ...
                restriction that duplicated prohibited. Set implementations also add a
        ...
        /*
            Queue
                ...
                For the most part, queues maintain a first-in, first-out order. One exception to
                this rule is the PriorityQueue implementation, which order elements according to
                a supplied comparator, or the elements' natural ordering.
         */
        ...
        /*
            Map
                ...
                Any data structure that "maps" keys to values, conceptually similar to
                a dictionary (sep. in Python).
        ...
        credentialsMap.put("skelsey", null); // no issue will null values
