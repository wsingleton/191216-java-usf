...
/*
    Prototypal Inheritance
        ...
        class-based inheritance system. Instead, JS is known for its use of the 
        "prototypal inheritance".
            ...
            - The prototype object has a prototype of its own, and so on until an 
              object is reached taht has null as its prototype.

            - Methods can be added to objects as properties, and any objet has
              access to its prototype's properties. The properties can be 
              redeclared with new implementation as a sort of "method overriding".
*/
