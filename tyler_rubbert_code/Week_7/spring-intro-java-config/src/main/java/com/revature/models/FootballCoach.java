...
@Component
public class FootballCoach implements InitializingBean, Coach, DisposableBean {
    ...
    // setter-based dependency constructor
    @Autowired
    ...
    public void postInit() {
        System.out.println("FootballCoach.postInit invoked!");
    }
    ...
    public String getDailyWorkout() {
        return "Do bear crawls to 40, 50, 60, 80, 100 yard lines";
    }
