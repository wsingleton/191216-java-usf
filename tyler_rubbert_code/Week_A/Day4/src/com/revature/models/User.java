...
public class User {
    ...
    /*
        Constructors are invoked to create a new instance of a class. We can include as many constructors as we
        need to gives us various ways to instantiate the same class, depending on what states we want to initialize.

        Constructor overloading - including multiple constructors within the same class
        Constructor chaining - calling a constructor belonging to the same class, within another constructor for that calls

        super - a keyword which
     */
    ...
    public User(String fn, String ln, String username, String pw, Role role) {
        ...
        // a call to the super class's constructor is implicitly here if not provided
        // super();
