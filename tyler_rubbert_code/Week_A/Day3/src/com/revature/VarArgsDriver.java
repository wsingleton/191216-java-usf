...
public class VarArgsDriver {
    /*
        The main method can use variable arguments and still b considered valid syntactically
     */
    ...
    /*
        We can make our variable arguments as many dimensions as desired, just add a set of
        square brackets and the ellipses to pass in a multi-dimensional array
     */
