...
public class UserRepository implements CrudRepository<User> {
...

    {
        ...
        userDb.put(key, new User(key, "Tyler", "Rubbert", "trubbert", "notpassword", Role.MANAGER)); key ++;
        userDb.put(key, new User(key, "Hoang", "Le", "hle", "fishballs", Role.PREMIUM_MEMBER)); key ++;
        userDb.put(key, new User(key, "Ben", "Burke", "bburke", "soccer", Role.BASIC_MEMBER)); key ++;
        userDb.put(key, new User(key, "Niles", "Diggs", "ndiggs", "physics", Role.ADMIN)); key ++;
    }
