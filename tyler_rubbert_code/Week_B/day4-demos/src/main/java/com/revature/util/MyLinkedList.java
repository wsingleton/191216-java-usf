...
public class MyLinkedList<T> {
    ...
    public void insert(T data) {
        ...
        // tail, setting its next node to the new one we just created.
        else {
    ...
    /**
     * Removes the first occurance of the provided key int he linked list.
     *
     * @param key
     * @return
     */
    public boolean removeByKey(T key) {
        ...
        // hand the scenariio where the list is empty
        if (this.head == null) {
            return false;
        }
        ...
        if (currentNode.getNextNode().equals(key)) {
            this.head = nextNode;
            return true;
        }
        ...
        // my implementation(almost works right)
//        Node<T> currentNode = this.head;
//        Node<T> nextNode = currentNode.getNextNode();
...
//        return false;
    ...
    public void printList() {
        ...
        // While hte current node is not null, print out node info and move on to the next
        while (currentNode != null) {
