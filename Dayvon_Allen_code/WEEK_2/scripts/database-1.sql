...
/*
need to add primary key, use alter
*/
...
--no need to commit the above statements, because all ddl keywords are implicitly committed

--Add values to the department table 

--if you are providing values for everything you don't need a column list
