...
public class CollectionDriver {
    ...
    public static void main(String[] args) {
        ...
        strings.add("test");
        // strings.add(new Cat()); // generics have always provided us with Type Safety!
        strings.add("test-2");
        ...
        for (int i = 0; i < strings.size(); i++) {
           //  System.out.println(strings[i]); // DO NOT USE SQUARE BRACKETS TO ACCESS INDEX POSITIONS, USE GET
