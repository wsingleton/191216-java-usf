...
public class User {
    ...
    public User(String fn, String ln, String username, String pw, Role role) {
        ...
        // super(); is a call to the super class's constructor is implicitly here if not provided

        firstName = fn; //"this" is not required if no parameters match the field name
        this.lastName = ln; // you can still include it though
        this.username = username; // her we must use "this" to clarify which one we are referencing
        password = pw;
        this.role = role;
    }
