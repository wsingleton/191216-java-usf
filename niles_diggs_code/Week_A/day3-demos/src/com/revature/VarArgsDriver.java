...
public class VarArgsDriver {
    /*
        The main method can use variable arguments, a form of polymorphism, and still be considered valid systematically
     */
    ...
    /*
        We can make our variable arguments as many dimensions as desired, just as a set of square brackets and the ellipse to pass in a multi-dimensional array.
     */
