...
public class UserRepository implements CrudRepository<User> {
    ...
    public Set<User> findUsersByRole(Role role) {
        ...
        try (Connection conn = ConnectionFactory.getInstance().getConnection()) {
            ...
            String sql = "SELECT * FROM demo.app_user WHERE role_id = ?";
    ...
    public Optional<User> findUserByUsername(String username) {
        ...
        try (Connection conn = ConnectionFactory.getInstance().getConnection()) {
            ...
            String sql = "SELECT * FROM demo.app_user WHERE username = ?";
            PreparedStatement pstmt = conn.prepareStatement(sql);
    ...
    public Optional<User> findUserByCredentials(String username, String password) {
        ...
        try (Connection conn = ConnectionFactory.getInstance().getConnection()) {
            ...
            String sql = "SELECT * FROM demo.app_user WHERE username = ? AND password = ?";
            PreparedStatement pstmt = conn.prepareStatement(sql);
            pstmt.setString(1, username);
    ...
    public void save(User newObj) {
        ...
        try (Connection conn = ConnectionFactory.getInstance().getConnection()) {
            ...
            String sql = "INSERT INTO demo.app_user VALUES (0, ?, ?, ?, ?, ?)";
    ...
    public Set<User> findAll() {
        ...
        try (Connection conn = ConnectionFactory.getInstance().getConnection()) {
            ...
            String sql = "SELECT * FROM demo.app_user";
    ...
    public Optional<User> findById(int id) {
        ...
        try (Connection conn = ConnectionFactory.getInstance().getConnection();) {
            ...
            String sql = "SELECT * FROM demo.app_user WHERE user_id = ?";
            PreparedStatement pstmt = conn.prepareStatement(sql);
            pstmt.setInt(1, id);
    ...
    public boolean update(User updatedObj) {
        ...
        try (Connection conn = ConnectionFactory.getInstance().getConnection();) {
            ...
            String sql = "UPDATE demo.app_user SET username = ?, password = ?, first_name = ?, last_name = ? " +
                    "WHERE user_id = ?";
            PreparedStatement pstmt = conn.prepareStatement(sql);
    ...
    public boolean deleteById(int id) {
        ...
        try (Connection conn = ConnectionFactory.getInstance().getConnection()) {
            ...
            String sql = "DELETE FROM demo.app_user WHERE user_id = ?";
            PreparedStatement pstmt = conn.prepareStatement(sql);
            pstmt.setInt(1, id);
