...
public class SorterTest {
    ...
    /*
    A JUnit rule is a component that intercepts test method calls and allows us to do something before
    a test method has run - typically adding additional constraints to the test case.
     */
    @Rule
    ...
    public void testSolutionWithNullArray() {
        String message = "If a null object is provided, return and empty int array";
