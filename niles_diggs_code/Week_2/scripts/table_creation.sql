...
-- CREATE the employees tabled AND define its columns AND their CONSTRAINTS
...
ROLLBACK; -- ddl statements are implicitly committed; cannot rollback

DELETE TABLE employees;
ROLLBACK; -- not implicitily committed you can rollback to the last save point or commit
