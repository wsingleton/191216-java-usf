...
Truncate TABLE employees; -- DDL statements are implicitly committed; cannot rollback beyond them
Rollback;

delete from employees; -- DML statements are not implicitly committed; we can roll back
