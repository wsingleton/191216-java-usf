...
SELECT * FROM ERS_REIMBURSEMENT WHERE NOT REIMB_AUTHOR = 1;

update ERS_USERS SET USER_ROLE_ID = 1 WHERE ERS_USERS_ID = 2 AND USER_ROLE_ID = 3;

CREATE USER ERS_USER IDENTIFIED BY PASSWORD 
...
GRANT SELECT ON ERS_APP.ERS_REIMBURSEMENTS to ERS_USER;
GRANT INSERT ON ERS_APP.ERS_REIMBURSEMENT to ERS_USER;


CREATE USER ERS_MANAGER IDENTIFIED BY PASSWORD
DEFAULT TABLESPACE users
TEMPORARY TABLESPACE temp
QUOTA 10M ON users;
...
GRANT SELECT ON ERS_APP.ERS_REIMBURSEMENT to ERS_MANAGER;
GRANT INSERT ON ERS_APP.ERS_REIMBURSEMENT to ERS_MANGER;
GRANT UPDATE ON ERS_APP.ERS_REIMBURSEMENT to ERS_MANAGER;
