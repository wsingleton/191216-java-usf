...
private TreeNode addRecursively(TreeNode currentNode, Integer value){
        //if the node passed to this is null return a new node containing the value
        if(currentNode == null){
            return new TreeNode(value); }
        /*
        if the vakue being added is less than the vaue of the current node, then recursively invoke this method
        addRecursively to attempt to add a new value to the left child of the current code
         */
        ...
        /*
        if the value being added is less than the value of the current node, then recursively invoke this method
        addRecursively to attempt to add a new value to the right child of the current code
         */
    ...
    /*
    If the value being added is neither less or greater than the value of the current node simply return the current node
     */
    return currentNode;
    }
