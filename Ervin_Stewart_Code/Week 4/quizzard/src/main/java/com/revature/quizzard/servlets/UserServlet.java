...
//        resp.setContentType("application/JSON");
    ...
    if(userIdParam == null){
        ...
        resp.getWriter().write(userJSON);}catch(Exception e){resp.setStatus(420);}
    }
    }
    ...
    protected void doPost(HttpServletRequest req,HttpServletResponse resp) throws ServletException, IOException{
        ...
        }catch(ResourcePersistenceException e){resp.setStatus(409);//conflict
            ErrorResponse err = new ErrorResponse(409,System.currentTimeMillis());
            err.setMessage(e.getMessage());
            writer.write(mapper.writeValueAsString(err));
        }catch(Exception e){resp.setStatus(500);}//internal server error
    }
