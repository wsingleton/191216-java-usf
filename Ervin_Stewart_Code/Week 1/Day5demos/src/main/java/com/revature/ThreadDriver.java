...
//        e1.run();
        ...
        There are overloaded versions of this method , which allows the developer the ability to tell a  thread to pause
        for a specific amount of time before " joining other threads.
         */
